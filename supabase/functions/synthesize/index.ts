...
serve(async (req) => {
  ...
  try {
    ...
    for (const file of files) {
      ...
      if (isImage) {
        // Send images directly for vision OCR
        ...
        // For text-based files, decode the base64
        ...
        // Truncate very large documents but keep keywords
        ...
        tools: [
          {
            ...
            function: {
              ...
              description: "Return synthesized study materials including notes, summary, flashcards, and quiz questions.",
              parameters: {
                type: "object",
                properties: {
                  master_notes: {
                    type: "string",
                    description: "Comprehensive merged notes in Markdown format, organized by subtopic with headers. Use **bold** for key terms.",
                  },
                  summary: {
                    type: "string",
                    description: "TL;DR summary in Markdown with key formulas, metrics, and important points.",
                  },
                  flashcards: {
                    type: "array",
                    items: {
                  ...
                  quiz: {
                    ...
                    items: {
                      ...
                      properties: {
                        ...
                        common_error: {
                          type: "string",
                          description: "Common mistake students make on this topic",
                        },
                      },
                      required: ["question", "options", "correct", "difficulty"],
                      additionalProperties: false,
                    },
                    description: "8-15 quiz questions with varying difficulty",
                  },
                },
